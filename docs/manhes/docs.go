// Package manhes Code generated by swaggo/swag. DO NOT EDIT
package manhes
...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.MangaListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.MangaDetailResponse"
                        }
                    },
                    "404": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ChapterListResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ChapterReadResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpsertTrackerRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.TrackerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "domain.ChapterListResponse": {
            "type": "object",
            "properties": {
                "chapters": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ChapterItem"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "domain.DictionaryResponse": {
            ...
            "properties": {
                ...
                "source_stats": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/domain.SourceStat"
                    }
                },
                "sources": {
                    "type": "object",
        ...
        "domain.MangaListResponse": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.MangaSummary"
                    }
                },
                "pageNumber": {
                    "type": "integer"
        ...
        "domain.TrackerResponse": {
            ...
            "properties": {
                ...
                "metadata": {
                    "description": "JSON string, use json.RawMessage on the domain Tracker",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
